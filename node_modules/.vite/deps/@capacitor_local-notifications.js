import { n as registerPlugin } from "./dist-CdERmLF6.js";
...
var LocalNotifications = registerPlugin("LocalNotifications", { web: () => import("./web-kTkqSMTL.js").then((m) => new m.LocalNotificationsWeb()) });
//#endregion
